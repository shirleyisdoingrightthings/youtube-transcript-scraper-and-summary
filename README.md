...
将任意 YouTube 视频链接转换为可直接发布的中文**图文精读稿**或**对话体逐字稿**，并自动归档至 Notion 与 Obsidian。适用于 AI/科技讲座、播客访谈、行业大会演讲等内容类型。
...
6. **同步 Obsidian** — 将带 YAML frontmatter 标签的 Markdown 复制到 Second Brain 目录
